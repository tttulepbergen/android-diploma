...
class CategoriesFragment : Fragment(R.layout.fragment_categories) {
    ...
    private fun loadCategories() {
        val localList = listOf(
            ...
            FoodItem(title = "Breads & Carbs", subtitle = "Bakery", imageRes = R.drawable.ic_bread, ingredients = ""),
            ...
            FoodItem(title = "Sweet Snacks", subtitle = "Candy and sweets", imageRes = R.drawable.ic_sweet, ingredients = ""),
            FoodItem(title = "Beverages", subtitle = "Drinks", imageRes = R.drawable.ic_beverages, ingredients = ""),
            FoodItem(title = "Cooking & Baking", subtitle = "Ingredients", imageRes = R.drawable.ic_cooking_baking, ingredients = ""),
            FoodItem(title = "Baby Food", subtitle = "Infant nutrition", imageRes = R.drawable.ic_baby_food, ingredients = ""),
